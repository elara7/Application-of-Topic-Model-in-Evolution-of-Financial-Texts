setwd('D:/paper_c/Elara/Documents/paper/14_jsdvar')
library(stringr)
a = read.csv('3jsdvar.csv',header = FALSE)
names(a)=c('文档数','字典长度','主题数','迭代次数','perplexity','var','perplexity-var')
...
{
  names(a)=c('文档数','字典长度','主题数','迭代次数','perplexity','var','perplexity-var')
  plot(a[,'主题数'],log(a[,'perplexity-var']),xlab='主题数',ylab='log(perplexity-var)',type='l')
  points(a[,'主题数'],log(a[,'perplexity-var']),pch=16)
  title(m,cex=0.5)
}
...
a = read.csv('3jsdvar.csv',header = FALSE)
plot_pic(a,'文档集A')
a = read.csv('44jsdvar.csv',header = FALSE)
plot_pic(a,'文档集B')
a = read.csv('88jsdvar.csv',header = FALSE)
plot_pic(a,'文档集C')
a = read.csv('340jsdvar.csv',header = FALSE)
plot_pic(a,'文档集D')
a = read.csv('706jsdvar.csv',header = FALSE)
plot_pic(a,'文档集E')
a = read.csv('1036jsdvar.csv',header = FALSE)
plot_pic(a,'文档集F')
dev.off()
