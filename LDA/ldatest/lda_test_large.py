...
para = list(itertools.product([250,300,500,1000],[1000]))
...
class test_f(object):
    ...
    def test_f(self,line):
        ...
        lda = gensim.models.ldamodel.LdaModel(corpus=self.text_train, num_topics=nt, id2word=self.dictionary, 
                                      ...
                                      , alpha='auto', eta='auto', 
                                      decay=0.5, offset=1.0, eval_every=False, 
...
pd.DataFrame(res).to_csv(main_path+'Elara/Documents/paper/LDA/lda_test_res_large.csv',header=None,index=None)