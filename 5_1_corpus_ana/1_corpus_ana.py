...
for i in os.listdir(main_path+'Elara/Documents/paper/seg/pos_unfilter/'):
    print('loading',i)
    temp = pd.read_csv(main_path+"Elara/Documents/paper/seg/pos_unfilter/"+i,
    ...
    if len(content_all)==0:
        content_all = copy.deepcopy([i[4] for i in temp2])
    else:
        content_all += copy.deepcopy([i[4] for i in temp2])
...
print('saving')
f1 = open(main_path+ 'Elara/Documents/paper/corpus_ana/res/word_pos_dicts.txt',"wb")
pickle.dump(word_pos_dicts, f1)
f1.close()

f1 = open(main_path+ 'Elara/Documents/paper/corpus_ana/res/word_len_dicts.txt',"wb")
pickle.dump(word_len_dicts, f1)
f1.close()

f1 = open(main_path+ 'Elara/Documents/paper/corpus_ana/res/doc_len.txt',"wb")
